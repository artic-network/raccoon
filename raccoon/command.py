...
def build_parser():
    ...
    a.add_argument('--reference-fasta', help='Reference FASTA file (used when alignment was created by mapping against a reference)', dest='reference_fasta', default=None)
    a.add_argument('--reference-id', help='Reference sequence ID in alignment (for GenBank features or validation)', dest='reference_id', default=None)
