...
def build_parser():
    ...
    a.add_argument('--flag-clustered', default=True, action=argparse.BooleanOptionalAction, dest='flag_clustered', help='Flag clustered SNPs (default: True, to skip set to False)')
